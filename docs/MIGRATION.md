...
- **Final pin verification.** `git -C .flowtron/core describe --tags` shows the pinned version recorded at the start (e.g., `v5.9.0`). A mismatch means the submodule drifted off the pin during migration.
