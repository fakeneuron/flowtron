...
- **Final pin verification.** `git -C _project/flowtron describe --tags` shows the pinned version recorded at the start (e.g., `v4.4.0`). A mismatch means the submodule drifted off the pin during migration.
