...
| `park-reason:` | `<code> — <prose>`; split on the first ` — `; codes are a closed set (step 4). | SPEC.md §"Tasknote frontmatter" → "Park reason" |
