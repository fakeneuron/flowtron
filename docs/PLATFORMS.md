...
- **`commands/`**: 16 `.md` slash-command stubs (`ft-task.md`,
...
- **`skills/`**: 16 `SKILL.md` skill bodies (one per command), some with
  lazy-load fragments (`ft-task/step-*.md`, including `step-4-debug-mode.md` and `step-5-loop-mode.md`; `ft-file-followup/park-mode.md`; `ft-audit/scaffold-bootstrap.md`) or sibling libraries (`ft-audit/passes/*.md`)
