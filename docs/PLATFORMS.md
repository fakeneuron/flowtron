...
- **`commands/`**: 15 `.md` slash-command stubs (`ft-task.md`,
  `ft-micro-task.md`, `ft-file-followup.md`,
  `ft-epic-discovery.md`, `ft-close-epic.md`, `ft-spec.md`, `ft-refactor.md`, the two `ft-audit`-family skills (`ft-audit.md`, `ft-audit-repo.md`),
  plus `ft-new-project.md`, `ft-release.md`, `ft-flowtron.md`,
  `ft-stats.md`, `ft-audit-context.md`, `ft-update.md`)
- **`skills/`**: 15 `SKILL.md` skill bodies (one per command), some with
  lazy-load fragments (`ft-task/step-*.md`, including `step-4-debug-mode.md` and `step-5-loop-mode.md`; `ft-file-followup/park-mode.md` and `starter-mode.md`; `ft-audit/scaffold-bootstrap.md`) or sibling libraries (`ft-audit/passes/*.md`)
...
- **`skills/`**: 15 `SKILL.md` wrappers, one per Claude `ft-*` skill slug.
