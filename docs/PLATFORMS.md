...
- **`commands/`**: 20 `.md` slash-command stubs (`ft-task.md`,
...
- **`skills/`**: 20 `SKILL.md` skill bodies (one per command), some with
...
- **`skills/`**: 20 `SKILL.md` wrappers, one per Claude `ft-*` skill slug.
