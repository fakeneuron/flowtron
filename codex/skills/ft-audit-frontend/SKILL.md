...
description: Run the Flowtron frontend audit workflow from Codex. Use for UI, accessibility, bundle, browser hygiene, or render performance reviews.
---

# ft-audit-frontend - Codex wrapper

Read and follow `../../../claude/skills/ft-audit-frontend/SKILL.md`.
