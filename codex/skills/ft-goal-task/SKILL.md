---
name: ft-goal-task
description: Start and drive a Flowtron goal-loop tasknote from Codex with execute-verify iterations until acceptance is proven.
---

# ft-goal-task - Codex wrapper

Read and follow `../../../claude/skills/ft-goal-task/SKILL.md`.
