...
description: Run the Flowtron security audit workflow from Codex. Use for secrets, auth, input handling, dependency, or boundary reviews.
---

# ft-audit-security - Codex wrapper

Read and follow `../../../claude/skills/ft-audit-security/SKILL.md`.
