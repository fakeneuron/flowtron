...
- **[docs/CONVENTIONS.md](docs/CONVENTIONS.md)** — external conventions flowtron adheres to (Conventional Commits, SemVer, GFM, Diátaxis) and declines (CHANGELOG, separate ADRs, release automation, pre-commit hooks), each with rationale.
