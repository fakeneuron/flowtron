...
Flowtron is built with flowtron: **849 tasks** closed through this exact
workflow between 2026-04-28 and 2026-09-08 (as of 2026-09-08) — each one with
...
- `SPEC/` — lazy SPEC modules (epic, starter, blocked, model, versioning, gates, cue-vocabulary, gate-discipline, tasknote-selection, loop, layout, plan-parser, scope-boundaries, tasknote-inserts, purpose-blurb, superseded-claims) plus `procedures/` (pasteable skill procedures); loaded on demand by skills
