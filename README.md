...
Flowtron is built with flowtron: **1011 tasks** closed through this exact
workflow between 2026-04-28 and 2026-09-21 (as of 2026-09-21) — each one with
...
- `SPEC/` — lazy SPEC modules (epic, starter, blocked, model, versioning, gates, gate-postures, cue-vocabulary, gate-discipline, post-closure, tasknote-selection, plan-filing, loop, layout, plan-parser, scope-boundaries, tasknote-inserts, purpose-blurb, superseded-claims, unattended-candidacy) plus `procedures/` (pasteable skill procedures) and `fixtures/plan/` (task-line grammar conformance fixtures shared by every PLAN.md parser); loaded on demand by skills
