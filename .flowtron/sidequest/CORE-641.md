...
Operator 2026-09-20: stay on `typescript@5.9` (in-range). No dual-package 6+7, no Oxlint/Biome swap, no 5→6 bump. Wait for the 7.1 API + typescript-eslint; then isolate-bump 5.9→7 and fix TS2882.
