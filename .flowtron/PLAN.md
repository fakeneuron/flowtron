...
- [ ] **CORE-485** [medium] | fleet-name-leakage-sweep — Per-site ratify-or-genericize verdict on fleet leakage in shipped Engine surfaces vs the project-agnostic claim: fleet project names in docs/PLATFORMS.md:145-147, docs/PHILOSOPHY.md:7-11, viz/src/archiveCache.ts:37, plus fakeneuron org URLs and ~/code hardcodes. Routed by natabula NAT-182.3 (tri-repo conformance).
