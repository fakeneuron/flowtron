...
> Lazy-loaded SKILL fragment. Loaded by `task` SKILL.md Step 1.5 when the model-mismatch or legacy-entry branch fires. See `claude/skills/task/SKILL.md` for the always-loaded core dispatch and the match-case path.
