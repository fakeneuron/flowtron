...
> Lazy-loaded SKILL fragment. Loaded by `task` SKILL.md Step 3c when an existing tasknote has `status: blocked`. See `claude/skills/task/SKILL.md` for the always-loaded core dispatch.
