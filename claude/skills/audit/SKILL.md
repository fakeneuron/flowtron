...
4. Do **not** write code changes, do **not** modify source files, do **not** open editors on flagged files. The audit writes tickets only — actual fixes happen in separate task cycles via `/task`.
