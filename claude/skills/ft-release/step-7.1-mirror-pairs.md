...
- **Release-gate only, like D and F–I.** The `drift` CI job runs the release-context-free subset (A, B, C, J, M, N, O) per `docs/CONVENTIONS.md` §"GitHub Actions CI"; promoting K there is a separate call, not implied by minting it.
