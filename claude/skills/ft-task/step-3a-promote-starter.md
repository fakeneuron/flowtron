...
> Lazy-loaded SKILL fragment. Loaded by `task` SKILL.md Step 3a when an existing tasknote has `status: starter`. See `claude/skills/ft-task/SKILL.md` for the always-loaded core dispatch.
