...
- [ ] **CORE-151** [sonnet] | skill-bare-codefences — Add language tags (markdown/text) to 6 bare code fence openers in ft-epic-discovery/SKILL.md and ft-close-epic/SKILL.md. Surfaced by audit 2026-05-23 (Finding #2, Low).
