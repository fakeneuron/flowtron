...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <button
      type="button"
      onClick={cycle}
      className="rounded border border-slate-300 bg-white px-3 py-1.5 text-base shadow-sm hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
