...
- `plan-flowtron.json` — implementation roadmap with area-prefixed tasks (e.g., CORE-###)
- `templates/plan-template.json` — base plan template (area-prefixed IDs)
...
- `_projects/flowtron/docs/Project-Setup-Guidelines.md` — Flowtron-specific base folder/archiving expectations
- `_projects/flowtron/docs/TaskNote-Guidelines-Template.md` — project-agnostic TaskNote workflow template to copy/adapt
...
### Quick Start (flowtron repo)

- Dev UI: `npm run dev`, then click "Load sample files" to try `public/samples/`
- Lint + tests: `npm run verify`
- Build: `npm run build`
